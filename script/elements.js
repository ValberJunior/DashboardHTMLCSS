...
export const BAIRRO = document.querySelector("#bairro");
export const CIDADE = document.querySelector("#cidade");
export const ESTADO = document.querySelector("#estado");
export const TURMA = document.querySelector("#turma");
